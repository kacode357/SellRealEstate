...
export default function Agencydangtinmain() {
    ...
    const updateWallet = async () => {
        try {
            ...
            const updatedAmount = parseFloat(numericAmount - lastPrice);
            ...
            const walletHistoryData = { walletId: getIdWallet, description: `Bạn đã bị trừ ${lastPrice} vào tài khoản` };
                ...
                if (Amout < lastPrice) {
                    ...
                    axios.post('http://swprealestatev2-001-site1.etempurl.com/api/invester/createNewRealEstate/' + userLoginBasicInformationDto.accountId, requestData)
                        .then(response => {
                            ...
                            resetData();
                            const thongbao ={
                                accountId : userLoginBasicInformationDto.accountId,
                                description : "Bạn đã tạo bất động sản "+ requestData.realestateName + " thành công và đang chờ phê duyệt"
                            }
                            const thongbaoAdmin ={
                                accountId : 43,
                                description : "Bất động sản "+ requestData.realestateName + " đang chờ bạn phê duyệt"
                            }
    ...
    return (
        ...
        <div className='container'>
            ...
            />
            <h1>Phí đăng một bài là {lastPrice}</h1>
