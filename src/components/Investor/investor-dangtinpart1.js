...
export default function Agencydangtinpart1({ sendData }) {
    ...
    const handleDescriptionChange = (e) => {
        ...
        if ( (words.length <= 200)) {
            ...
            toast.error('Mô tả phải nhiều hơn 30 ký tự và không được vượt quá 200 kí tự');
        }
        ...
        <div className='thongtinchitietdangtin'>
            <div className='thongtinchitietdangtindulieu'>
                ...
                <div>
                    ...
                    <input type="number" name="length" value={propertyInfo.length} onChange={handleInputChange} placeholder="Nhập dữ liệu" />
                    <span>Chiều rộng (đơn vị m)</span>
                    <input type="number" name="width" value={propertyInfo.width} onChange={handleInputChange} placeholder="Nhập dữ liệu" />
