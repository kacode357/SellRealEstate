...
class CallApi {
    ...
    static async getAllPostingPrice() {
        try {
            const response = await axios.get('http://swprealestatev2-001-site1.etempurl.com/api/PostingPrice/GetAllPostingPrice');
            return response.data;
        } catch (error) {
            console.error('Error fetching real estate data:', error);
            return null;
    ...
    static async createNotification(data) {
        try {
            const response = await axios.post('http://swprealestatev2-001-site1.etempurl.com/api/notification/createNotification', data);
            return response.data;
        } catch (error) {
            console.error('Error fetching real estate data:', error);
            return null;
    ...
    static async getAllNotificationByAccount(accountId) {
        try {
            const response = await axios.get(`http://swprealestatev2-001-site1.etempurl.com/api/notification/getAllNotificationByAccount/${accountId}`);
            return response.data;
        } catch (error) {
            console.error('Error fetching real estate data:', error);
            return null;
    ...
    static async bookmarkbyAccount(accountId ,data) {
        try {
            const response = await axios.put(`http://swprealestatev2-001-site1.etempurl.com/api/notification/bookmarkbyAccount/${accountId}`, data);
            return response.data;
        } catch (error) {
            console.error('Error fetching real estate data:', error);
            return null;
