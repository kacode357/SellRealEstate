                    ...
                    <div>
                        ...
                        {editing ? (
                            ...
                            <div>
                                ...
                                <button class="btn btn-outline-success" onClick={doimatkhau}>Đổi mật khẩu</button>
    ...
    return (
        <div>
            ...
            <div style={{ margin: '20px' }}>
                <button class="btn btn-outline-success" style={{ margin: '20px' }} onClick={handleSave}>Lưu</button>
            </div>
            <div style={{ margin: '20px' }}>
