    ...
    return (
        <div className="admin-all-account">
            ...
            <div className='table-container' style={{marginRight:'100px'}}>
                <h2 style={{textAlign:'center', fontWeight:'bold', marginTop:'100px'}}> Điều phối agency</h2>
                        ...
                        <tbody>
                            {filteredCustomers.map((reservation, index) => (
                                <tr key={index}>
                                    ...
                                    <td  onClick={() => handleNavigate(reservation.bookingTime, reservation.bookingDate)}>{reservation.status === 1 ? 'Đang chờ phân phối người dẫn xem' : reservation.status}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
