...
const LocationSelector = ({ onSelect, selectedLocation }) => {
    ...
    return (
        <div className='select-all-location'>
            <ProvinceDropdown onSelect={handleProvinceChange} selectedProvince={selectedProvince}  className="cus-local"/>
            <DistrictDropdown provinceCode={selectedProvince} onSelect={handleDistrictChange} selectedDistrict={selectedDistrict} className="cus-local"/>
            <WardDropdown districtCode={selectedDistrict} onSelect={handleWardChange} selectedWard={selectedWard} className="cus-local"/>
