...
import Thongbaoall from './components/thongbaoall';
...
import CustomerXemanhcocban from './components/Customer/customer-xemanhcocban';
import CustomerthongtinRealEstate from './components/Customer/customer-thongtinRealEstate';
import Customerbuttonthongtinbaydongsan from './components/Customer/customer-buttonthongtinbaydongsan';
...
import Admintatcarealestate from './components/Admin/admin-tatcarealestate';
import AdminTiendangbai from './components/Admin/admin-tiendangbai';
    ...
    <Router>
      ...
      {!isAdmin && <>
        ...
        <Routes>
          ...
          <Route path='/thongbao/:id' element={<><Thongbaoall /></>} />
          {/* Customer Routes */}
          ...
          <Route path="/khachhang-xemanhcocban" element={<CustomerXemanhcocban />} />
          <Route path="/khachhang-real-estate/:id" element={<CustomerthongtinRealEstate />} />
          <Route path="/real-estate-detail/:id" element={<Customerbuttonthongtinbaydongsan />} />
          ...
          <Route path="/admin-tatcarealestate" element={<Admintatcarealestate />} />
          <Route path="/admin-tiendangbai" element={<AdminTiendangbai />} />
